<#
.SYNOPSIS
Reescribe el historial del repositorio con la hora fijada a las 00:00.

.DESCRIPTION
Este script iterará sobre todos los commits referenciando a un script sh
para cambiar la marca de tiempo a las 00:00:00. Usa git filter-branch.
#>

Write-Host "Iniciando reescritura de GIT_AUTHOR_DATE y GIT_COMMITTER_DATE a las 00:00..."
