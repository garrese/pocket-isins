...
- `context/database_schema.md`: Definition of local Isar models and their relationships.
...
2.  **Context Maintenance:** If, as an AI, you make a decision that changes or expands the project's technical knowledge (e.g., adding a new Isar model, changing the state provider), your *immediate obligation* is to document the change in the corresponding file within `context/`.
